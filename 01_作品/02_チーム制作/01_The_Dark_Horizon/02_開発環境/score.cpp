...
void InitScore(void)
{
	...
	{	
		...
		pVtx[1].pos = g_posScore + D3DXVECTOR3((float)MAX_NUM_WIDTH + (MAX_NUM_WIDTH * nCnt), 0.0f, 0.0f);
		pVtx[2].pos = g_posScore + D3DXVECTOR3(0.0f + (MAX_NUM_WIDTH * nCnt), MAX_NUM_HEIGHT, 0.0f);
		pVtx[3].pos = g_posScore + D3DXVECTOR3((float)MAX_NUM_WIDTH + (MAX_NUM_WIDTH * nCnt), MAX_NUM_HEIGHT, 0.0f);
		...
		// 頂点カラーの設定
		pVtx[0].col = D3DCOLOR_RGBA(50, 50, 50, 255);
		pVtx[1].col = D3DCOLOR_RGBA(50, 50, 50, 255);
		pVtx[2].col = D3DCOLOR_RGBA(50, 50, 50, 255);
		pVtx[3].col = D3DCOLOR_RGBA(50, 50, 50, 255);
