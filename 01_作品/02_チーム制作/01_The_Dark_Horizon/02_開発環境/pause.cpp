...
void UpdatePause(void)
{
	...
	{//一度すべてを半透明に
		//頂点カラーの設定
		pVtx[0].col = D3DXCOLOR(0.0f, 1.0f, 0.6f, 0.5f);
		pVtx[1].col = D3DXCOLOR(0.0f, 1.0f, 0.6f, 0.5f);
		pVtx[2].col = D3DXCOLOR(0.0f, 1.0f, 0.6f, 0.5f);
		pVtx[3].col = D3DXCOLOR(0.0f, 1.0f, 0.6f, 0.5f);
